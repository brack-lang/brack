...
// use brack_common::{
//     errors::{Debug, Error, Info, Warning},
...
// fn emit_error_diagnostic(logger: &Logger, error: &Error) {
...
// fn emit_warning_diagnostic(logger: &Logger, warning: &Warning) {
//     let writer = StandardStream::stderr(ColorChoice::Always);
//     let config = Config::default();
...
// fn emit_debug_output(debug: &Debug) {
//     let tag = "Debug";
...
// fn get_file_from_error(logger: &Logger, error: &Error) -> SimpleFile<String, String> {
//     let cli_command = SimpleFile::new(String::from("CLI Command"), logger.raw_command.clone());
//     match error {
//         Error::FailedToGetFileNameFromPath { .. } => cli_command,
